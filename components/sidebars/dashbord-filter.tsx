...
type Variant = 'all' | 'connections' | 'saved-directory' | 'pending' | 'dashboard' | 'all-directory';
...
const positions = ['CEO', 'CTO', 'CFO', 'COO', 'Manager', 'Engineer', 'Director', 'Founder', 'Co-Founder', 'Partner', 'Managing Director'];

export const FilterSidebar: React.FC<FilterSidebarProps> = ({ variant, onFilterChange }) => {
    ...
    const hasActiveFilters = selectedCountry || selectedIndustry || selectedPosition;

    return (
        <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
            <SheetTrigger asChild>
                <div className={`flex items-start ${isDirectoryPage ? 'w-[30%]' : 'w-[10%]'}`}>
                    {variant === 'dashboard' && (
                        <div className={`flex items-center justify-end md:items-end md:pr-2 lg:items-center ${isDirectoryPage ? '' : ''} `}>
                            <img
                    ...
                    {variant === 'all' && (
                        ...
                        >
                            ...
                            {hasActiveFilters && (
                                <span className="absolute -top-1 -right-1 flex h-3 w-3 items-center justify-center rounded-full bg-green-500 text-[8px] text-white lg:-top-1 lg:-right-2">
                                </span>
                            )}
                        </div>
                    )}
                    ...
                    {isDirectoryPage && (
                        ...
                        >
                            <img src={images.refresh} className="h-8 w-8" alt="" />
                        </button>
                    )}
                </div>
            </SheetTrigger>
            ...
            <SheetContent className="w-[336px] overflow-y-auto top-[53px] h-[80vh] max-w-[240px] overflow-y-auto lg:h-full lg:top-0 lg:max-w-max rounded-l-[40px] p-5 lg:p-10 pb-20 xl:pb-0 dark:bg-gray-800 dark:text-gray-100">
                <SheetHeader>
                    <SheetTitle className="mb-2 text-base lg:text-lg font-semibold text-deepBlack md:text-2xl dark:text-gray-100">Filter By</SheetTitle>
                    <SheetDescription className="text-[11px] lg:text-xs text-deepBlack md:text-sm dark:text-gray-400">
                        Filter users by country, industry, or position to find the right connections.
                    </SheetDescription>
                </SheetHeader>
                ...
                <div className="grid gap-6 px-2 pt-1 pb-4 md:py-4">
                    ...
                    <div className="relative">
                        <label htmlFor="country" className="text-xs lg:text-sm font-semibold text-darkBlue md:text-base dark:text-gray-200">
                            Country
                        </label>
                        <div className="mt-2">
                            <Select
                            ...
                            >
                                ...
                                >
                                    <SelectValue className="w-full whitespace-nowrap" placeholder="Choose a country" />
                                    {openCountry ? (
                    ...
                    {/* Industry */}
                    <div className="relative">
                        <label htmlFor="industry" className="text-xs lg:text-sm font-semibold text-darkBlue md:text-base dark:text-gray-200">
                            Industry
                        </label>
                        <div className="mt-2">
                            <Select
                    ...
                    {/* Position */}
                    <div className="relative">
                        <label htmlFor="position" className="text-sm font-semibold text-darkBlue md:text-base dark:text-gray-200">
                            Position
                        </label>
                        <div className="mt-2">
                            <Select
