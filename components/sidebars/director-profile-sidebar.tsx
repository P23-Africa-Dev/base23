...
import DirectorProfileModal from '@/components/modals/director-profile-modal';
            ...
            <div className="flex h-full w-full flex-col gap-3 overflow-hidden rounded-[28px] bg-white p-3 shadow-[0px_4px_24px_rgba(0,0,0,0.10)]">
                ...
                <div className="flex min-h-0 flex-1 flex-col justify-between overflow-hidden rounded-[22px] bg-[#1B363A] px-5 py-5">
                    ...
                    <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="flex shrink-0 flex-col gap-3">
                            <button
                                ...
                                className="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-[#DFF1E8] transition hover:bg-[#D0EBDD]"
                            >
                                <UserRoundPlus className="h-5.5 w-5.5 text-[#1B363A]" strokeWidth={1.5} />
                            </button>
                            <button className="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-[#DFF1E8] transition hover:bg-[#D0EBDD]">
                                <MessageSquareText className="h-5.5 w-5.5 text-[#1B363A]" strokeWidth={1.5} />
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 mt-4">
                        ...
                        <Star className="h-3.75 w-3.75 fill-[#B886F8] text-[#B886F8]" />
                    </div>
                    ...
                    <div className="flex gap-2 mt-2">
                        <button
                            onClick={() => setModalOpen(true)}
                            className="flex flex-1 items-center justify-center gap-2.5 rounded-2xl bg-[#B886F8] py-3.25 text-[12px] font-semibold text-white transition hover:opacity-90"
                        >
                            <UserRoundPlus className="h-4 w-4" strokeWidth={1.5} />
                            See Profile
                        </button>
                        <button className="flex flex-1 items-center justify-center gap-2.5 rounded-2xl bg-transparent py-3.25 text-[12px] font-medium text-white transition hover:bg-white/5">
