...
// Payment modal moved to dashboard after registration - users need to be authenticated first
// import { OnBoardingStepModal } from '@/components/modals/auth/onboarding-step-modal';
// import { PaymentModal } from '@/components/modals/auth/PaymentModal';
...
const sampleTags = [
    ...
    { label: 'Tech Savviness', value: 'tech_savviness' },
    { label: 'Customer Retention', value: 'customer_retention' },
    { label: 'Emotional Intelligence', value: 'emotional_intelligence' },
    { label: 'Team Collaboration', value: 'team_collaboration' },

    { label: 'Project / Product Management', value: 'project_product_management' },
    { label: 'Innovation Strategy', value: 'innovation_strategy' },
];
            ...
            <div className="overflow-hidden w-full ">
                ...
                >
                    <div className="relative  mx-auto max-w-md xl:max-w-[650px]">
                        {/* Heading */}
                        <div className="mb-4">
                            <h2 className="mb-1 text-2xl font-extrabold text-primary lg:text-3xl dark:text-black">What’s your secret sauce?</h2>
                        ...
                        <div className="w-full xl:max-w-[590px]">
                            <form onSubmit={handleSubmit(onSubmit)} className="mr-6 space-y-6 lg:mr-0">
                                    ...
                                    <div className="-ml-1.5 no-scrollbar flex max-h-[40vh] flex-wrap gap-3 overflow-y-auto py-2">
                                        {sampleTags.map((tag) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <img src={isSelected ? images.checkedBadge : images.badge} alt="" className="h-7 w-7" />
                                ...
                                <div className="space-y-3 py-2">
                                    <h4 className="mb-2 text-base font-bold dark:text-black">I’m looking for;</h4>
                                    <p className="pl-1 text-sm text-grayLight">select max 3 tags</p>
                                        ...
                                        {sampleTags.map((tag) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`flex items-center justify-center space-x-2 rounded-3xl px-2 py-2 pr-3 xl:pr-6 xl:pl-4 font-GtrialsTh text-[14px] tracking-wide transition-all duration-200 lg:px-8 lg:text-base ${
                                                        isSelected
                                                            ? 'bg-[#2ABFBB] font-bold text-secondaryWhite shadow-[0px_4px_2px_-1px_rgba(0,0,0,0.12),0px_4px_0px_-1px_rgba(0,0,0,0.12)]'
                                                            : 'font-semibold text-[#0B1727]/60 shadow-md'
                ...
                <img src={images.bottomFormBgP} className="absolute md:hidden  top-[60%] z-2 h-auto w-full object-cover" alt="" />
            </div>
        </>
    );
}
