...
// Connection type for the slider components (bridging API data with existing component structure)
...
export default function Referrals() {
    ...
    const sliderData: SliderConnection[] = useMemo(() => {
        ...
        const sortedMatches = [...filteredMatches].sort((a, b) => b.compatibility - a.compatibility);

        // Debug log to verify data from API
        console.log('Building slider data from matches:', sortedMatches.map(m => ({
            id: m.id,
            name: m.name,
    ...
    return (
        <AppLayout>
            ...
            <div className="relative border-0 bg-transparent pt-0 pb-2.5">
                ...
                >
                    <div className={`relative z-10 no-scrollbar flex h-screen max-h-[96vh] w-full flex-col gap-3 overflow-y-auto lg:px-3 lg:pb-1`}>
                        <div className="h-screen gap-5 overflow-hidden lg:pt-2 page-transition">
                            ...
                            <div className="mx-auto flex w-full items-center justify-center self-center bg-darkBlue px-4 py-3 lg:w-[85%] lg:bg-transparent lg:px-0">
                                <div className="flex w-[170px] flex-col leading-4 text-white not-italic lg:w-[280px] lg:leading-5 lg:text-deepBlack lg:italic">
                                    <h2 className="text-[10px] font-light lg:text-[20px]"> Your Smart</h2>
                                    <h3 className="text-[14px] font-bold tracking-wide lg:text-[27px]"> Matches</h3>
                                </div>
                                ...
                                <div className="flex w-28 items-end justify-end lg:w-60">
                                    <div className="flex items-end justify-end">
                                        ...
                                        >
                                            <div className={`relative hidden h-8 w-8 lg:block ${isRefreshing ? 'animate-spin' : ''}`}>
                                                <img src={images.refreshcolored} className="absolute object-contain" alt="Refresh matches" />
                                            </div>
                                            <div className={`relative h-6 w-6 lg:hidden ${isRefreshing ? 'animate-spin' : ''}`}>
                                                <img src={images.refreshNew} className="absolute object-contain" alt="Refresh matches" />
                                            </div>
                                        </button>
                                    </div>
                                </div>
                                        ...
                                        <div className="relative no-scrollbar flex-1 overflow-y-auto pb-10">
                                            ...
                                            <div className="sticky top-0 z-2 flex items-center justify-between overflow-hidden border-b-1 bg-white px-2 pt-1 pb-2">
                                                <div className="">
                                                    {/* Mobile */}
                                                    <>
                                                        <h2 className="text-[14px] leading-1 font-extrabold text-deepBlack">Recent Network</h2>
                                                    </>
                                                </div>
                                            </div>
                                                ...
                                                {isLoadingRecentNetwork ? (
                                                    ...
                                                    recentNetwork.map((user) => (
                                                        <UserProfileSidebar
                                                            ...
                                                            interest={user.categories || user.can_help_with || ''}
                                                            reviews="5"
                                    ...
                                    <div className="flex w-full flex-col gap-y-2.5 bg-transparent px-2">
                                        ...
                                        >
                                            <div className="flex w-full justify-end">
                                                <div className="flex h-[37px] w-[37px] items-center justify-center rounded-lg bg-[#F5F4F4] shadow-md">
                                                    <div className="relative h-5.5 w-5.5">
                                                        <img src={images.margicband} className="absolute object-contain" alt="" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="-mt-2 flex flex-col pl-6 leading-4.5 text-secondaryWhite italic">
                                                ...
                                                <h4 className="text-[18px] font-extrabold">New Profile</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex gap-x-2.5">
                                        ...
                                        >
                                            <div className="relative h-5 w-5">
                                                <img src={images.adduser} className="absolute object-contain" alt="" />
                                            </div>
                                        </button>
                                    </div>
                                </div>
