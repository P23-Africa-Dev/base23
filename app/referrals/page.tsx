                                ...
                                <div className="flex flex-1 flex-col gap-1 min-w-0">
                                  <div className="flex items-start justify-between gap-1">
                                    ...
                                    <div className="flex shrink-0 items-center gap-1">
                                      ...
                                      <svg className="h-4 w-4 fill-[#27E6A7]" viewBox="0 0 20 20">
                                  ...
                                  <div className="grid grid-cols-2 gap-x-2">
                                    <div>
                                      <p className="text-[10px] font-semibold text-[#27E6A7]">Title</p>
                                      <p className="truncate text-[11px] font-bold text-deepBlack">{person.role}</p>
                                    </div>
                                    <div>
                                      <p className="text-[10px] font-semibold text-[#27E6A7]">Industry</p>
                                      <p className="truncate text-[11px] font-bold text-deepBlack">{person.industry || "—"}</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
