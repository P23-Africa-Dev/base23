        ...
        >
            <div className="w-full p-8 lg:overflow-y-auto">
                <div className="relative z-10 mx-auto max-w-md">
                    <div className="mb-10">
                        <h2 className="mb-1 text-2xl font-extrabold text-primary lg:text-3xl dark:text-black">Reset your Password</h2>
                    ...
                    <div className="max-w-sm">
                        <form onSubmit={submit} className="space-y-7">
                            <div className="relative w-full">
                                <Label htmlFor="email" className="absolute -top-2.5 left-8 bg-white px-3 text-sm text-gray-800">Email</Label>
                                <Input
                                    id="email"
                                    type="email"
                                    autoComplete="email"
                            ...
                            <div className="relative w-full">
                                <label htmlFor="password" className="absolute -top-2.5 left-8 bg-white px-3 text-sm text-gray-800">Password</label>
                                <Input
                                    id="password"
                                    type="password"
                            ...
                            <div className="relative w-full">
                                <label htmlFor="password_confirmation" className="absolute -top-2.5 left-8 bg-white px-3 text-sm text-gray-800">Confirm Password</label>
                                <Input
